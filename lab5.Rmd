...
While we've been using 'attach' and 'detach' up to this point (and, whew boy, everybody has had trouble with cleaning up *detach* after a bunch of *attach* commands!) I think it's  time to take off the training wheels and rampdown your use of 'attach' and 'detach'.
