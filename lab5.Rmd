...
That shows earnings over different ages. Econ majors have the highest earnings, followed by Engineering, then Computer Science (although they start highest) and the rest of the majors. You might have a lot of questions about that, including *why?*, *how?*, and *really?!* You will dig into those with some regressions.
